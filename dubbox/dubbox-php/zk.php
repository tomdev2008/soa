...
class Zookeeper_Example
{
	...
	public function __construct($address) {
		$this->zookeeper = new Zookeeper($address);var_dump($this->zookeeper);
	}
...
$servers = $zk->getChildren('/dubbo/com.ttfc.soa.dubbo.proxy.service.DemoServiceProxy/providers');
$one = $servers[0];
$requests= parse_url(urldecode($one));
